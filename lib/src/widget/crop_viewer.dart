...
import 'package:instagram_crop_images_video/src/insta_assets_crop_controller.dart';
import 'package:instagram_crop_images_video/src/video_play/video_page_builder.dart';
        ...
        builder: (_, previewAsset, __) =>
            Selector<DefaultAssetPickerProvider, List<AssetEntity>>(
                ...
                builder: (_, List<AssetEntity> selected, __) {
                  ...
                  //AssetEntity asset111 = selected.elementAt(0);

                //  print("selected${selected.ty}");
